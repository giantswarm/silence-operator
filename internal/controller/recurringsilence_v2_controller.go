...
// RecurringSilenceV2Reconciler reconciles a RecurringSilence object
type RecurringSilenceV2Reconciler struct {
	client.Client
}
...
func (r *RecurringSilenceV2Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	logger := log.FromContext(ctx)

	logger.Info("reconciling RecurringSilence")

	var recurringSilence v1alpha2.RecurringSilence
...
func (r *RecurringSilenceV2Reconciler) SetupWithManager(mgr ctrl.Manager) error {
