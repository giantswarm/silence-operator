...
var _ = Describe("RecurringSilence Controller", func() {
	...
	AfterEach(func() {
		...
		resource := &monitoringv1alpha1.RecurringSilence{}
	...
	It("Should create a Silence from a RecurringSilence", func() {
		...
		recurringSilence := &monitoringv1alpha1.RecurringSilence{
			ObjectMeta: metav1.ObjectMeta{
				Name:      resourceName,
				Namespace: "default",
			},
			Spec: monitoringv1alpha1.RecurringSilenceSpec{
				Schedule: "* * * * *",
				Template: monitoringv1alpha1.SilenceSpec{
