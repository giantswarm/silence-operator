...
kubectl apply --server-side -f https://raw.githubusercontent.com/giantswarm/silence-operator/config/crd/bases/monitoring.giantswarm.io_silences.yaml

# For new namespace-scoped silences (recommended)
kubectl apply --server-side -f https://raw.githubusercontent.com/giantswarm/silence-operator/config/crd/bases/observability.giantswarm.io_silences.yaml
```
